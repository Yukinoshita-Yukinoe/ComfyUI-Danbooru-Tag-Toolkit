...
from .dataset_saver_node import NODE_CLASS_MAPPINGS as DATASET_SAVER_NODE_CLASS_MAPPINGS
from .dataset_saver_node import NODE_DISPLAY_NAME_MAPPINGS as DATASET_SAVER_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS = {
    ...
    **DATASET_SAVER_NODE_CLASS_MAPPINGS,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **DATASET_SAVER_NODE_DISPLAY_NAME_MAPPINGS,
